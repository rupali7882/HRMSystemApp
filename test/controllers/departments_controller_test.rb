...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { employee: @department.employee, name: @department.name, user_id: @department.user_id } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { employee: @department.employee, name: @department.name, user_id: @department.user_id } }
